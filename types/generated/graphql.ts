...
export type EventAttendeeFieldsFragment = { id: string, event_id: string, member_id: string, response: string, name: string, professional_title: string | null, avatar_url: string | null };
