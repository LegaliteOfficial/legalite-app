...
const documents: Documents = {
    ...
    "\n  query ClientAssignments {\n    clientAssignments {\n      id\n      client_id\n      member_id\n      assignment_role\n      name\n      professional_title\n      avatar_url\n    }\n  }\n": types.ClientAssignmentsDocument,
    "\n  mutation SetClientAssignments($input: SetClientAssignmentsInput!) {\n    setClientAssignments(input: $input) {\n      id\n      client_id\n      member_id\n      assignment_role\n      name\n      professional_title\n      avatar_url\n    }\n  }\n": types.SetClientAssignmentsDocument,
    "\n  query CaseAssignments($case_id: ID!) {\n    caseAssignments(case_id: $case_id) {\n      id\n      case_id\n      member_id\n      assignment_role\n      name\n      professional_title\n      avatar_url\n    }\n  }\n": types.CaseAssignmentsDocument,
    ...
    "\n  query FirmMembers {\n    firmMembers {\n      id\n      firm_id\n      profile_id\n      firm_role\n      professional_title\n      employment_type\n      status\n      name\n      email\n      gba_number\n      verification_status\n      joined_at\n      left_at\n    }\n  }\n": types.FirmMembersDocument,
    "\n  mutation ChangeMemberRole($input: ChangeMemberRoleInput!) {\n    changeMemberRole(input: $input) {\n      id\n      firm_role\n      professional_title\n      status\n      name\n      email\n    }\n  }\n": types.ChangeMemberRoleDocument,
    "\n  mutation ChangeProfessionalTitle($input: ChangeProfessionalTitleInput!) {\n    changeProfessionalTitle(input: $input) {\n      id\n      firm_role\n      professional_title\n    }\n  }\n": types.ChangeProfessionalTitleDocument,
    "\n  mutation DeactivateMember($member_id: ID!) {\n    deactivateMember(member_id: $member_id) {\n      id\n      status\n    }\n  }\n": types.DeactivateMemberDocument,
    "\n  mutation ReactivateMember($member_id: ID!) {\n    reactivateMember(member_id: $member_id) {\n      id\n      status\n    }\n  }\n": types.ReactivateMemberDocument,
    "\n  mutation LeaveFirm {\n    leaveFirm\n  }\n": types.LeaveFirmDocument,
    ...
    "\n  query MyVerificationDocuments {\n    myVerificationDocuments {\n      id\n      document_type\n      file_url\n      file_name\n      file_type\n      file_size\n      status\n      rejection_reason\n      created_at\n    }\n  }\n": types.MyVerificationDocumentsDocument,
    "\n  mutation UploadVerificationDocument(\n    $input: UploadVerificationDocumentInput!\n  ) {\n    uploadVerificationDocument(input: $input) {\n      id\n      document_type\n      file_url\n      file_name\n      status\n      created_at\n    }\n  }\n": types.UploadVerificationDocumentDocument,
};
