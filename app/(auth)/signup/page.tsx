...
export default function SignupPage() {
  ...
  // The hook owns the setAuth side-effect. We only need the mutation here.
  const { registerMutation, loading: registering } = useRegisterUser()
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            {isSubmitting || registering ? 'Creating account…' : 'Create My Account'}
          </button>
        </form>
